...
/**
 * The base condition-bean of question.
 * @author DBFlute(AutoGenerator)
 */
public class BsQuestionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected QuestionCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public QuestionCB acceptPK(Integer questionId) {
        assertObjectNotNull("questionId", questionId);
        BsQuestionCB cb = this;
        cb.query().setQuestionId_Equal(questionId);
    ...
    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_QuestionId_Desc();
        return this;
    }
     ...
     */
    public QuestionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public QuestionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected QuestionCQ doGetConditionQuery() {
    ...
    protected QuestionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected QuestionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        QuestionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected QuestionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new QuestionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<QuestionCB> unionCBLambda) {
        final QuestionCB cb = new QuestionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final QuestionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<QuestionCB> unionCBLambda) {
        final QuestionCB cb = new QuestionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final QuestionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<QuestionCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<QuestionCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "question"; }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from challenge_detail_history where ...) as FOO_MAX} <br>
         ...
         * }, ChallengeDetailHistory.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<ChallengeDetailHistoryCB, QuestionCQ> derivedChallengeDetailHistory() {
         ...
         */
        public HpSDRFunction<QuestionCB, QuestionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<QuestionCB> sq, QuestionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public QuestionCB dreamCruiseCB() {
        QuestionCB cb = new QuestionCB();
        cb.xsetupForDreamCruise((QuestionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<QuestionCB> columnQuery(final SpecifyQuery<QuestionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected QuestionCB xcreateColumnQueryCB() {
        QuestionCB cb = new QuestionCB();
        cb.xsetupForColumnQuery((QuestionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<QuestionCB> orCBLambda) {
        xorSQ((QuestionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<QuestionCB> andCBLambda) {
        xorSQAP((QuestionCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return QuestionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return QuestionCQ.class.getName(); }
